...
static void DecodeIITType(unsigned &NextElt, ArrayRef<unsigned char> Infos,
  ...
  case IIT_TOKEN:
    ...
    return;
  case IIT_DEP:
    OutputTable.push_back(IITDescriptor::get(IITDescriptor::Dep, 0));
    return;
  case IIT_METADATA:
...
static Type *DecodeFixedType(ArrayRef<Intrinsic::IITDescriptor> &Infos,
  ...
  case IITDescriptor::Dep: return Type::getDepTy(Context);
...
bool Intrinsic::matchIntrinsicType(Type *Ty, ArrayRef<Intrinsic::IITDescriptor> &Infos,
  ...
  switch (D.Kind) {
    ...
    case IITDescriptor::Dep: return !Ty->isDepTy();
